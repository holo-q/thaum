...
public sealed class LoggingIntrinsicsGenerator : IIncrementalGenerator
{
    ...
    private static void GenerateFor(SourceProductionContext spc, Compilation compilation, ClassDeclarationSyntax cls)
    {
        ...
        sb.AppendLine("{");
        // Logger field
        sb.Append("    private static readonly global::Microsoft.Extensions.Logging.ILogger __log = global::Thaum.Core.Utils.Logging.For<")
          .Append(typeName).Append(typeParams).AppendLine(">();");

        // Instance helpers
        sb.AppendLine("    protected void trace(string message, params object?[] args) => __log.LogTrace(message, args);");
        sb.AppendLine("    protected void info(string message, params object?[] args) => __log.LogInformation(message, args);");
        sb.AppendLine("    protected void warn(string message, params object?[] args) => __log.LogWarning(message, args);");
        sb.AppendLine("    protected void err(string message, params object?[] args) => __log.LogError(message, args);");
        sb.AppendLine("    protected void err(System.Exception ex, string message, params object?[] args) => __log.LogError(ex, message, args);");
        sb.AppendLine("    protected void print(object? value = null) => __log.LogInformation(value is null ? \"\" : value.ToString());");
        sb.AppendLine("    protected void println(object? value = null) => __log.LogInformation(value is null ? \"\" : value.ToString());");
        sb.AppendLine("    protected void assert(bool condition, string? message = null) { if (!condition) __log.LogError(message ?? \"Assertion failed\"); }");

        // Static helpers
        sb.AppendLine("    protected static void TRACE(string message, params object?[] args) => __log.LogTrace(message, args);");
        // Static helpers
        sb.AppendLine("    protected static void INFO(string message, params object?[] args) => __log.LogInformation(message, args);");
        sb.AppendLine("    protected static void WARN(string message, params object?[] args) => __log.LogWarning(message, args);");
        sb.AppendLine("    protected static void ERR(string message, params object?[] args) => __log.LogError(message, args);");
        sb.AppendLine("    protected static void ERR(System.Exception ex, string message, params object?[] args) => __log.LogError(ex, message, args);");
        sb.AppendLine("    protected static void PRINT(object? value = null) => __log.LogInformation(value is null ? \"\" : value.ToString());");
        sb.AppendLine("    protected static void PRINTLN(object? value = null) => __log.LogInformation(value is null ? \"\" : value.ToString());");
        sb.AppendLine("    protected static void ASSERT(bool condition, string? message = null) { if (!condition) __log.LogError(message ?? \"Assertion failed\"); }");
